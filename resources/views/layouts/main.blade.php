...
<head>
    ...
    <style>
        ...
        /* === 1. PERBAIKAN UKURAN ICON === */
        .bi {
            vertical-align: -.125em;
            fill: currentColor;
            width: 1rem;
            /* Batasi lebar default icon */
            height: 1rem;
            /* Batasi tinggi default icon */
            flex-shrink: 0;
            /* Mencegah icon gepeng di dalam flexbox */
        }
        ...
        /* === 2. PERBAIKAN LAYOUT SIDEBAR & HEADER (Bootstrap Dashboard Template) === */
        @media (min-width: 768px) {
            .sidebar {
                position: fixed;
                top: 0;
                ...
                z-index: 100;
                padding: 60px 0 0;
                /* Memberi ruang agar tidak tertutup navbar atas */
...
<body>
    ...
    <div class="dropdown position-fixed bottom-0 inset-e-0 mb-3 me-3 bd-mode-toggle"> <button
